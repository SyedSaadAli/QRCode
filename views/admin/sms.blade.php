                            ...
                            <div id="input" class="p-5">
                                <div class="preview">
                                    <div>
                                        ...
                                        <input id="regular-form-1" type="text" name="sms" class="form-control form-control-rounded" placeholder="SMS Number">
                                    </div>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <a class="flex items-center mr-3" onclick="confirmation_edit(event)" href="{{url('/Edit_SMS',$data2->id)}}"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                <a class="flex items-center text-danger" onclick="confirmation_delete(event)" href="{{url('/Delete_SMS',$data2->id)}}" data-tw-toggle="modal" > <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
...
<!-- END: Content -->
        ...
        <script>
            ...
            function confirmation_edit(event){
                ...
                swal({
                    title: "Are you sure to edit this SMS ?",
            ...
            function confirmation_delete(event){
                ...
                console.log(urlToRedirect);
                swal({
                    title: "Are you sure to delete this SMS ?",
                    text: "You won't be able to revert this!",
                    icon: "warning",
                    buttons: true,
                    dangerMode:true,
