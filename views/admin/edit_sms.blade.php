                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            <form action="{{url('Edit_SMS_Confirm',$data[0]->id)}}" method="post" >
                                @csrf
                            <div id="input" class="p-5">
                                <div class="preview">
                                    <div>
                                        <label for="regular-form-1" class="form-label">SMS</label>
                                        <input id="regular-form-1" type="text" name="edit_sms" value="{{$data[0]->sms}}" class="form-control form-control-rounded" placeholder="SMS">
                                    </div>
