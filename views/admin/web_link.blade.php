            ...
            <div class="content">
                <div class="intro-y flex items-center mt-8">
                    <h2 class="text-lg font-medium mr-auto">
                        Create QRCODE Of links/Message
                    </h2>
                </div>
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            <form action="{{url('Web_Link')}}" method="post" >
                                @csrf
                            <div id="input" class="p-5">
                                <div class="preview">
                                    <div>
                                        <label for="regular-form-1" class="form-label">Links/Message</label>
                                        <input id="regular-form-1" type="text" name="website_link" class="form-control form-control-rounded" placeholder="Website Link">
                                    </div>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">Websites</th>
                    ...
                    <tr class="intro-x">
                        ...
                        <td >
                            <div class="flex">
                                <div >
                                    ...
                                    <div ><a href="{{$data2->link}}" target="_blank">{{$data2->link}}</a></div>
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <a class="flex items-center mr-3" onclick="confirmation_edit(event)" href="{{url('/Edit_website_link',$data2->id)}}"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                <a class="flex items-center text-danger" onclick="confirmation_delete(event)" href="{{url('/Delete_website_link',$data2->id)}}" data-tw-toggle="modal" > <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
...
<!-- END: Content -->
        ...
        <script>
            ...
            function confirmation_edit(event){
                ...
                swal({
                    title: "Are you sure to edit this link ?",
