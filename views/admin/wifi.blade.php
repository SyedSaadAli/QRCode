                ...
                <div class="grid grid-cols-12 gap-6 mt-5">
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            <form action="{{url('WIFI')}}" method="post" >
                                @csrf
                            <div id="input" class="p-5">
                                <div class="preview">
                                    <div>
                                        <label for="regular-form-1" class="form-label">Encryption</label>
                                        <input id="regular-form-1" type="text" name="encryption" class="form-control form-control-rounded" placeholder="WIFI Encryption">
                                    </div>
                                    <br>
                                    <div>
                                        <label for="regular-form-1" class="form-label">Title</label>
                                        <input id="regular-form-1" type="text" name="title" class="form-control form-control-rounded" placeholder="WIFI Title">
                                    </div>
                                    <br>
                                    <div>
                                        <label for="regular-form-1" class="form-label">Password</label>
                                        <input id="regular-form-1" type="text" name="password" class="form-control form-control-rounded" placeholder="WIFI Password">
                                    </div>
            ...
            <table class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-nowrap">Encryption</th>
                    ...
                    <tr class="intro-x">
                        ...
                        <td class="table-report__action w-56">
                            <div class="flex justify-center items-center">
                                ...
                                <a class="flex items-center mr-3" onclick="confirmation_edit(event)" href="{{url('/Edit_WIFI',$data2->id)}}"> <i data-lucide="check-square" class="w-4 h-4 mr-1"></i> Edit </a>
                                <a class="flex items-center text-danger" onclick="confirmation_delete(event)" href="{{url('/Delete_WIFI',$data2->id)}}" data-tw-toggle="modal" > <i data-lucide="trash-2" class="w-4 h-4 mr-1"></i> Delete </a>
...
<!-- END: Content -->
        ...
        <script>
            ...
            function confirmation_edit(event){
                ...
                swal({
                    title: "Are you sure to edit this WIFI ?",
            ...
            function confirmation_delete(event){
                ...
                console.log(urlToRedirect);
                swal({
                    title: "Are you sure to delete this WIFI ?",
                    text: "You won't be able to revert this!",
                    icon: "warning",
                    buttons: true,
                    dangerMode:true,
